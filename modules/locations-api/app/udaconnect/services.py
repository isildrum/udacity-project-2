...
class LocationService:
    ...
    def create(location: Dict) -> Location:
        ...
        #Send location through gRPC
        channel = grpc.insecure_channel("10.43.156.16:5005")
        stub = locations_pb2_grpc.LocationServiceStub(channel)

        # Update this with desired payload
        grpc_location = locations_pb2.LocationMessage(
            latitude = location["latitude"],
            longitude = location["longitude"],
        ...
        response = stub.Create(grpc_location)

        return LocationService.last_record()
